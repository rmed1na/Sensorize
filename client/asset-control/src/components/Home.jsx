        ...
        <div className="component component__home">
            ...
            <div className='filter'>
                <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
                    <InputLabel className='filter__select filter__select--label'>Tipo</InputLabel>
                    <Select
                        ...
                        <MenuItem sx={{ minWidth: 120, fontSize: '0.875rem' }} value={0}>Todos</MenuItem>
                        { deviceTypes.map(dt => <MenuItem sx={{ fontSize: '0.875rem' }} key={dt.code} value={dt.code}>{dt.name}</MenuItem>) }
                    </Select>
                </FormControl>
            </div>
